...
class Turtle_chaser:
    def __init__(self, name, coord, speed):
        ...
        self.sub = rospy.Subscriber(
            'turtle1/cmd_vel', Twist, self.update_direction)
        self.sub2 = rospy.Subscriber(
            name + '/pose', Pose, self.update_position)
        self.sub3 = rospy.Subscriber(
            'turtle1/pose', Pose, self.update_goal_position)
...
rospy.init_node('turtles_pair')

turtles.append(Turtle_chaser(name='First',
                             coord=(1.0, 1.0, 0.0), speed=1.0))
turtles.append(Turtle_chaser(
    name='Second', coord=(1.0, 10.0, 0.0), speed=0.5))
